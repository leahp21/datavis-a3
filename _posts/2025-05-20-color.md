...
Since taking the course, I've subconsciously started to analyze the effectiveness of any color palette I see in my day-to-day life. I've become more aware of conflicting color palettes and potential impacts of color palette choices for people with color blindness. From the in-class color activity and this course, I've learned to compare different color palettes when mapping color to data. Finalizing the first palette that you can think of, without thinking of a vis user, can lead to decreased effectiveness. In industry, I will apply what I've learned through the color course item to use the best color palette for a viz. The wrong color choice could mislead the user, which was showcased in the misleading vis activity. A choropleth in the misleading viz activity used hues to encode increasing magnitude. A clearer design choice would've incorporated saturation, not hues. (see below)

<figure class="row">
    <img src="{{ site.baseurl }}/assets/images/choropleth.jpg" alt="choropleth" style="width:100%">
    <figcaption>Example of vis potentially increasing cognitive load of user through poor magnitude encoding choice.
    </figcaption>
</figure>
